...
var pollSchema = mongoose.Schema({
	...
	opt1	    :{ text: { type: String, minlength: 3, required: true}, 
					score: { type: Number, default: 0},
					optid: { type: Number, default: 1}
				},

	opt2      	:{ text: { type: String, minlength: 3, required: true}, 
					score: { type: Number, default: 0},
					optid: { type: Number, default: 2}
				},	

	opt3 		:{ text: { type: String, minlength: 3, required: true}, 
					score: { type: Number, default: 0},
					optid: { type: Number, default: 3}
				},

	opt4        :{ text: { type: String, minlength: 3, required: true}, 
					score: { type: Number, default: 0},
